...
extract($_POST);
    ...
    try {
        ...
        $sql = $conexionSeleccion->prepare("DELETE from datospersonales where id_datopersonal = :id_datopersonal");
            ...
            fechanacimiento, entidadnacimiento, rfc, sexo, cartanaturalizacion, telefonocasa, telefonocelular, otrotelefono, correoelectronico, fechaactualizo, plazaevaluar, datosActualizados, rechazoContratacion) VALUES(:id_datopersonal, :profesion, :curp,
            :nombre, :appaterno, :apmaterno, :estado, :delegacion, :localidad, :colonia, :calle, :numexterior, :numinterior, :codigopostal, :fechanacimiento, :entidadnacimiento, :rfc, :sexo, :cartanaturalizacion, :telefonocasa, :telefonocelular, :otrotelefono, :correoelectronico,:fechaactualizo,:plazaevaluar, :datosActualizados, :rechazoContratacion)");
                $sql->execute(array(
                    ':id_datopersonal'=>$id_user,
                    ':profesion' => $profesion,
                    ':curp' => $curp,
